...
# X, y = make_regression(n_samples=1000,  # 样本个数
#                            n_features=25,  # 特征个数
#                            n_informative=3, #重复特征# 簇的个数
#                            random_state=0)
# from sklearn.model_selection import train_test_split
# xtr, xte = train_test_split(X, test_size=0.2, random_state=20)
# ytr, yte = train_test_split(y, test_size=0.2, random_state=20)
### 特征选择
# RFE
...
def RFECV(Train, Test, header, catId):
    ...
    # RF = AdaBoostRegressor(n_estimators=10)
    # from sklearn.linear_model import LinearRegression
    # clf = LinearRegression()
